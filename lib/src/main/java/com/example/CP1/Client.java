...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            client.encryptedTransfer("src\\main\\java\\com\\example\\sampleData\\smallFile.txt", "smallFileCP1.txt");
            client.encryptedTransfer("src\\main\\java\\com\\example\\sampleData\\medianFile.txt", "medianFileCP1.txt");
            client.encryptedTransfer("src\\main\\java\\com\\example\\sampleData\\largeFile.txt", "largeFileCP1.txt");
