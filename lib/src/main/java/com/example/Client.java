...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        // Client init at localhost and port 6789
        ...
        try {
            ...
            client.encryptedTransfer("RSA", "src\\main\\java\\com\\example\\sampleData\\smallFile.txt", "smallFile.txt");
    ...
    private void uploadFile(String pathToFile, String name, String encryptionType) throws Exception {
        ...
        Key key;
        if (encryptionType.contains("RSA")) key = serverCertificate.getPublicKey();
        else key = symKey;
        ...
        output.write(encryptionType.substring(0, 3).getBytes());
    ...
    private void encryptedTransfer(String RSAAES, String path, String fileName) throws Exception {
        String encryption;
